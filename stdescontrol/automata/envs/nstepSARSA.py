...
with open('automata/envs/rp_backup/case'+str(case)+'.csv', newline='') as csvfile:
...
env.reset(filename="automata/envs/SM/Renault2.xml", rewards=reward, stop_crit=1, products=10, last_action=last_actions, probs=probabilities)
